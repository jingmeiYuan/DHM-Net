...
if __name__ == '__main__':
    model = YOLO(r'D:\BaiduNetdiskDownload\ultralytics-yolo11-20251122\ultralytics-yolo11-main\ultralytics\cfg\models\11\yolo11m-MutilBackbone-HAFB.yaml') # YOLO11
    # model.load('yolo11n.pt') # loading pretrain weights
    model.train(data=r'D:\BaiduNetdiskDownload\ultralytics-yolo11-20251122\ultralytics-yolo11-main\dataset\data.yaml',
                cache=False,
                imgsz=640,
                epochs=200,
                batch=8,
