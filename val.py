...
if __name__ == '__main__':
    ...
    if model.task == 'detect':
        ...
        print('-' * 20 + 'The data in the paper is subject to the following results' + '-' * 20)
        print('-' * 20 + 'The data in the paper is subject to the following results' + '-' * 20)
        print('-' * 20 + 'The data in the paper is subject to the following results' + '-' * 20)
        print('-' * 20 + 'The data in the paper is subject to the following results' + '-' * 20)
        print('-' * 20 + 'The data in the paper is subject to the following results' + '-' * 20)
        ...
        model_info_table.field_names = ["GFLOPs", "Parameters", "Preprocessing Time per Image",
                                        "Inference Time per Image", "Postprocessing Time per Image",
                                        "FPS(Preprocess+Inference+Postprocess)", "FPS(Inference Only)",
                                        "Model File Size"]
